...
const ClubGrid = () => {
  return (
    <div className="min-h-screen flex items-center justify-center overflow-x-hidden">
      ...
      <div className="absolute w-[60%] items-center justify-center ">
        ...
        <Image
          src={ourclubs}
          alt=""
          className="w-[100%] md:w-[50%] ml-2 md:ml-30 lg:ml-60"
        />
    ...
    group-hover:scale-[1.6]
            ...
            {/* Animated border */}
            <div
              className="absolute inset-0 rounded-[6px] border-[1px] border-white/0
                 group-hover:border-cyan-200/40 transition-all duration-1000"
            />

            {/* Cyan corner accents */}
            <div
              className="absolute top-0 right-0 w-2 h-2 border-t-[1px] border-r-[1px]
                 border-cyan-300/0 group-hover:border-cyan-300/50
                 transition-all duration-500 delay-100"
            />
            <div
              className="absolute bottom-0 left-0 w-2 h-2 border-b-[1px] border-l-[1px]
                 border-cyan-300/0 group-hover:border-cyan-300/50
                 transition-all duration-500 delay-100"
            />
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
              <div
                className="absolute top-1/4 left-1/4 w-1 h-1 rounded-full bg-cyan-400/80
                   animate-float"
              />
              <div
                className="absolute top-1/3 right-1/4 w-1 h-1 rounded-full bg-cyan-300/60
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Letting imaginations run wild through words, poetry, and
                storytelling.
              </p>
            </div>
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
              <div
                className="absolute top-1/4 left-1/4 w-1 h-1 rounded-full bg-red-400/80 
                   animate-float"
              />
              <div
                className="absolute top-1/3 right-1/4 w-1 h-1 rounded-full bg-red-300/60 
                   animate-float delay-200"
              />
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Empowering students to grow and innovate through real-world tech
                solutions.
              </p>
            </div>
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
              <div
                className="absolute top-1/4 left-1/4 w-1.5 h-1.5 rounded-full bg-emerald-400/80 
                   animate-float"
              />
              <div
                className="absolute top-1/3 right-1/4 w-1.5 h-1.5 rounded-full bg-emerald-300/60 
                   animate-float delay-200"
              />
            </div>
          </div>
    ...
    group-hover:scale-[1.6]
            ...
            >
              ...
              >
                Expressing emotions through graceful moves and vibrant dance
                forms
              </p>
            </div>
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
              <div
                className="absolute top-1/4 left-1/4 w-1 h-1 rounded-full bg-pink-400/80
                   animate-float"
              />
              <div
                className="absolute top-1/3 right-1/4 w-1 h-1 rounded-full bg-pink-300/60
                   animate-float delay-200"
              />
            </div>
          </div>
    ...
    gorup-hover:scale-[1.6]
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
              <div
                className="absolute top-1/4 left-1/4 w-1 h-1 rounded-full bg-blue-400/80
                   animate-float"
              />
              <div
                className="absolute top-1/3 right-1/4 w-1 h-1 rounded-full bg-blue-300/60
                   animate-float delay-200"
              />
            </div>
          </div>
    ...
    group-hover:scale-[1.6]
            ...
            >
              ...
              >
                Uniting gaming enthusiasts for epic virtual battles and strategy
                showdowns
              </p>
            </div>
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
              <div
                className="absolute top-1/4 left-1/4 w-1 h-1 rounded-full bg-amber-400/80
                   animate-float"
              />
              <div
                className="absolute top-1/3 right-1/4 w-1 h-1 rounded-full bg-amber-300/60
                   animate-float delay-200"
              />
            </div>
          </div>
    ...
    group-hover:scale-[1.4]
            ...
            >
              ...
              >
                A collaborative space where queries meet clarity and concepts
            ...
            {/* Animated border */}
            <div
              className="absolute inset-0 rounded-[8px] border-[1.5px] border-white/0
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
              <div
                className="absolute top-1/4 left-1/4 w-2 h-2 rounded-full bg-indigo-400/80
                   animate-float"
              />
              <div
                className="absolute top-1/3 right-1/4 w-2 h-2 rounded-full bg-indigo-300/60
                   animate-float delay-200"
              />
            </div>
          </div>
    ...
    group-hover:scale-[1.6]
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
              <div
                className="absolute top-1/4 left-1/4 w-1 h-1 rounded-full bg-teal-400/80
                   animate-float"
              />
              <div
                className="absolute top-1/3 right-1/4 w-1 h-1 rounded-full bg-teal-300/60
                   animate-float delay-200"
              />
            </div>
          </div>
    ...
    group-hover:scale-[1.6]
            ...
            >
              ...
              >
                Igniting minds through powerful speeches and thought-provoking
                discussions
              </p>
            </div>
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
              <div
                className="absolute top-1/4 left-1/4 w-1 h-1 rounded-full bg-fuchsia-400/80
                   animate-float"
              />
              <div
                className="absolute top-1/3 right-1/4 w-1 h-1 rounded-full bg-fuchsia-300/60
                   animate-float delay-200"
              />
            </div>
          </div>
    ...
    group-hover:scale-[1.3]
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
              <div
                className="absolute top-1/4 left-1/4 w-2 h-2 rounded-full bg-sky-400/80
                   animate-float"
              />
              <div
                className="absolute top-1/3 right-1/4 w-2 h-2 rounded-full bg-sky-300/60
                   animate-float delay-200"
              />
            </div>
          </div>
    ...
    group-hover:scale-[1.6]
            ...
            >
              ...
              >
                Celebrating diversity and creativity through colorful cultural
                fusions
              </p>
            </div>
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
              <div
                className="absolute top-1/4 left-1/4 w-1 h-1 rounded-full bg-rose-400/80
                   animate-float"
              />
              <div
                className="absolute top-1/3 right-1/4 w-1 h-1 rounded-full bg-rose-300/60
                   animate-float delay-200"
              />
            </div>
          </div>
    ...
    group-hover:scale-[1.6]
            ...
            >
              ...
              >
                Fueling passion, discipline, and teamwork through thrilling
                games and athletic spirit
              </p>
            </div>
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
              <div
                className="absolute top-1/4 left-1/4 w-1 h-1 rounded-full bg-lime-400/80
                   animate-float"
              />
              <div
                className="absolute top-1/3 right-1/4 w-1 h-1 rounded-full bg-lime-300/60
                   animate-float delay-200"
              />
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Driving innovation and technical brilliance through teamwork and
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
              <div
                className="absolute top-1/4 left-1/4 w-2 h-2 rounded-full bg-violet-400/80
                   animate-float"
              />
              <div
                className="absolute top-1/3 right-1/4 w-2 h-2 rounded-full bg-violet-300/60
                   animate-float delay-200"
              />
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            <div
              className="w-full h-full scale-100 group-hover:scale-[0.714] /* 1/1.4 */
            ...
            >
              ...
              >
                Bringing stories to life with powerful performances and
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
              <div
                className="absolute top-1/4 left-1/4 w-1 h-1 rounded-full bg-yellow-400/80
                   animate-float"
              />
              <div
                className="absolute top-1/3 right-1/4 w-1 h-1 rounded-full bg-yellow-300/60
                   animate-float delay-200"
              />
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                The heartbeat of campus news, capturing every moment, voice, and
                vibe of CGEC
              </p>
            </div>
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
              <div
                className="absolute top-1/4 left-1/4 w-1 h-1 rounded-full bg-green-400/80
                   animate-float"
              />
              <div
                className="absolute top-1/3 right-1/4 w-1 h-1 rounded-full bg-green-300/60
                   animate-float delay-200"
              />
            </div>
          </div>
